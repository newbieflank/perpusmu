...
public class Admin extends javax.swing.JPanel {
    ...
    private void searchList() throws SQLException {
        ...
        try {
            pst = con.prepareStatement("select * from users where username Like '%" + search.getText() + "%'");
            rs = pst.executeQuery();
            while (rs.next()) {
                model.addRow(new Object[]{rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4)});
            }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (ID_users != null) {
            try {
                ...
                String status = getStatus(ID_users);
                if (status.equals("admin")) {
                    JOptionPane.showMessageDialog(jDialog1, "Anda tidak dapat menghapus pengguna dengan status admin");
                    return; // Keluar dari method deleteButtonActionPerformed
                }
...
// Method untuk mendapatkan status pengguna
    private String getStatus(String userID) throws SQLException {
        String status = "";
        PreparedStatement pst = con.prepareStatement("SELECT status FROM users WHERE ID_users = ?");
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        ID_users = model.getValueAt(index, 0).toString();
